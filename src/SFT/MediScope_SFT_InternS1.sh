...
# 启动训练并获取PID
swift sft \
    --model '/root/VLM_Med/Slake_SFT_output/InternS1_mini/v0-20260226-221636/checkpoint-850-merged' \
    --dataset '/root/VLM_Med/datasets/MediScope/data.jsonl' \
    --train_type lora \
    --lora_rank 16 \
    --lora_dropout 0.05 \
    --lorap_lr_ratio 16\
    ...
    --logging_steps 1 \
    --max_length 8192 \
    --output_dir '/root/VLM_Med/MediScope_SFT_output'\
    --dataset_num_proc 4 \
